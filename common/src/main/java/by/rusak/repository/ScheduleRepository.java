...
public interface ScheduleRepository extends JpaRepository<Schedule, Long>,
    ...
    List <Schedule> findSchedulesByIdCar(Long idCar);

    List<Schedule> findSchedulesByIdCarAndIsFreeTrue(Long idCar);

    List<Schedule> findSchedulesByIdCarAndIsFreeTrueAndUseDayAfter(Long idCar, Timestamp rentalStartDay);
